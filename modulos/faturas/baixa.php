...
else
{
	...
	$consulta_cliente = mysqli_query("SELECT id,fantasia FROM clientes WHERE id='$id_cliente' LIMIT 1") or die (mysql_error());
...
$consulta = mysqli_query("SELECT * FROM $tabela $filtro ORDER BY vencimento,status") or die (mysqli_error());
while($n = mysqli_fetch_array($consulta))
{
